...
const DICT: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "hall.card.pinned": "永恒刻名者 #{n}",
    "hall.card.recent": "留言",
    "hall.card.etched": "刻于",
    "hall.card.justNow": "刚刚",
    "hall.card.minutesAgo": "{n} 分钟前",
    "hall.card.hoursAgo": "{n} 小时前",
    "hall.card.daysAgo": "{n} 天前",
    "hall.card.close": "按 ESC 或点外部关闭",
    "hall.hint": "点击名字查看完整留言",
  ...
  en: {
    ...
    "hall.card.pinned": "ETERNAL SIGNER #{n}",
    "hall.card.recent": "MESSAGE",
    "hall.card.etched": "ETCHED",
    "hall.card.justNow": "just now",
    "hall.card.minutesAgo": "{n} min ago",
    "hall.card.hoursAgo": "{n} hr ago",
    "hall.card.daysAgo": "{n} days ago",
    "hall.card.close": "ESC or click outside to close",
    "hall.hint": "Click a name to read its message",
